...
android {
    ...
    defaultConfig {
        applicationId = "com.optigasto.optigasto"
        minSdk = 24  // Android 7.0 - Requerido para Firebase y funcionalidades modernas
    ...
    buildTypes {
        release {
            ...
            // Deshabilitar minificación temporalmente para evitar problemas con R8
